...
<html lang="en">
  ...
  #Home {padding-top:150px;padding-bottom:75px; background-color: #fff;}
  #Exercises{padding-top:150px; padding-bottom:75px;background-color: #7EC0EE;}
  .rounded {
  border-radius: 10px;
									...
									<div class="container">
										...
										<div class="collapse navbar-collapse" id="myNavbar">
											<ul class="nav navbar-nav navbar-right">
											  ...
											  <li> <a href="#Exercises">Dead.Lifts</a>	</li>
											</ul>
										</div>
									</div>
								</div>
